...
function loadReadAttachments() {
    const attachments = Office.context.mailbox.item.attachments || [];
    const listDiv     = document.getElementById("read-attach-header");
    const footerDiv   = document.getElementById("bundle-footer");

    if (!attachments.length) {
        listDiv.innerHTML = `<div class="read-attach-header">
            <span class="read-section-label">Attachments</span>
            <div class="mode-bar-mini">
                <span class="mode-label" id="lbl-individual">Individual</span>
                <label class="toggle-switch">
                    <input type="checkbox" id="chk-bulk" checked />
                    <span class="toggle-track"><span class="toggle-thumb"></span></span>
                </label>
                <span class="mode-label active" id="lbl-bundle">Bundle</span>
            </div>
        </div>`;
        footerDiv.classList.add("hidden");
        document.getElementById("btn-upload-bundle").disabled = true;
